...
class PyramidNet(nn.Module):
    ...
    def __init__(self, num_classes, dataset='cifar10', depth=164, alpha=200, bottleneck=True):
    ...
    def forward(self, x, return_feature=False, return_feature_list=False):
        if self.dataset == 'cifar10' or self.dataset == 'cifar100':
            ...
            feature5 = self.bn_final(feature4)
            feature5 = self.relu_final(feature5)
